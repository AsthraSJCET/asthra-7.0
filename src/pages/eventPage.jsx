...
const Capture = () => {
  ...
  const tickets =
    context_.tickets !== null
      ? Object.values(context_.tickets).map((a) => {
          return a.event_code;
        })
      : [];
  return (
              ...
              <div className="p-5 lg:pl-20 lg:pr-20 pt-8 mx-auto bg-black">
                <div className="lg:pl-20 lg:pr-20">
                  <div className="flex justify-between flex-row">
                    <h1
                      className={
                        "lg:text-5xl text-3xl font-spaceGrotesk text-white font-bold pb-4 tracking-tight"
                      }
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-6">
                  <div id="block1" className="md:col-span-3">
                        ...
                        {data.event_seat !== 0 && data.event_price !== 0 ? (
                          <>
                            ...
                            <span className=" text-[#CCFF00] text-xl font-bold">
                              {String(
                                parseInt(data.event_seat) -
                                  parseInt(data.event_sold)
                              )}
                            </span>
                          </>
                        ) : null}
                    ...
                    <div className="w-full lg:pl-20 lg:pr-20  py-4 font-spaceGrotesk text-white">
                      {/* <h3 className="font-bold font-spaceGrotesk text-2xl pb-6">DESCRIPTION</h3> */}
                    ...
                    <div className="lg:px-20 py-4 font-spaceGrotesk text-white">
                      <h3 className="font-bold font-spaceGrotesk text-2xl pb-2">
                        CONTACT
                      </h3>
                    ...
                    <div className="w-full flex items-center justify-center">
                      {tickets.includes(data.code) ? (
                        ...
                        <>
                          {" "}
                          {data.event_price === 0 ? (
                            <TicketAsthraPassInitial
                              data={data}
                              user_data={context_}
                            />
                          ) : (
                            <TicketWorkshopInitial
                              data={data}
                              user_data={context_}
                            />
                          )}
