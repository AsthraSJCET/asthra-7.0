    ...
    <>
      ...
      <div className="container my-32 mx-auto  text-white font-spaceGrotesk tracking-tight">
            ...
            <a href="tel:+917306266971">
              <div>
                <div className="contact-container mt-3 transition-all duration-300 flex   bg-zinc-800 px-5 py-5 rounded-md hover:bg-white hover:text-black">
                  <div
                    className="contact-icon px-6 py-5 border-white/20 border-solid border-2 rounded-xl mr-3 "
        ...
        <div className="mx-4 mt-10">
          <iframe
            title="Map"
            className="bg-zinc-800 rounded-md w-full h-96"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3932.458478967004!2d76.72617135333483!3d9.72717485230427!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc8944aaebb3ba492!2sSt.+Joseph's+College+of+Engineering+and+Technology%2C+Palai!5e0!3m2!1sen!2sin!4v1513403141725"
          ></iframe>
        </div>
        <div className="mx-4 mt-10"></div>
      </div>
    </>
  );
}
