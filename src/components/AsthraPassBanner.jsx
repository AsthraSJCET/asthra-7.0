...
function AsthraPassBanner() {
  return (
    <div className="flex flex-col md:flex-row bg-[#1D1D1D] p-8 font-spaceGrotesk">
      ...
      <div className="flex-initial lg:pl-10">
        ...
        <Link to="/register/ASTHRA_PASS" className="text-lime-400 hover:text-lime-600 font-bold mt-6">GET YOUR ASTHRAPASS NOW</Link>
      </div>
    </div>
  )
}
...
export default AsthraPassBanner;
