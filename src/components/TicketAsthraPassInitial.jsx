  ...
  return (
    <div className="max-w-lg" onContextMenu={(e) => e.preventDefault()}>
      ...
      <div className="bg-zinc-800 rounded-b-lg w-full pb-8 lg:mr-40">
        ...
        >
          <path
            d="M174.881 151.94L87.4792 202.402L0.077859 151.94L0.0778664 51.018L87.4792 0.556809L174.881 51.018L174.881 151.94Z"
            fill="url(#paint0_radial_488_38352)"
          />
          <defs>
            <radialGradient
              id="paint0_radial_488_38352"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(87.4792 101.479) rotate(-157.188) scale(121.411)"
            >
        ...
        <h2 className="pl-8 pr-8 text-4xl font-spaceGrotesk text-white font-medium pt-4 max-w-sm tracking-tight">
          Get all-access with AsthraPass!
        </h2>
        <p className="pl-8 pr-8  pt-2 pb-4 text-gray-300 text-md">
          With AsthraPass, you can now get access to all events (excluding
          workshops) for just ₹ 300!
        </p>
