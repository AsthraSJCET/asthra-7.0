...
class AsthraAppMain extends React.Component {
  ...
  syncData = () => {
    publicAPI
      ...
      .then((response) => {
        this.setState({
          asthra_user: response.data.user,
            ...
            <Routes>
              <Route path="/" element={<IndexTemplate />}>
                ...
                <Route
                  ...
                  element={
                    <>
                      <ListPageTemplate page="workshop" />
                    </>
                  }
                />
                <Route
                  ...
                  element={
                    <>
                      <ListPageTemplate page="competition" />
                    </>
                  }
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    <>
                      <ListPageTemplate page="exhibition" />
                    </>
                  }
                />
